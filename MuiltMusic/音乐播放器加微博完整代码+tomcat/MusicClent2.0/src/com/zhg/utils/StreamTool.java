...
public class StreamTool {
	...
	public static void save(InputStream in,String path,Handler handler) throws IOException{
	...
	public static void readData(InputStream in,OutputStream out,Handler handler) throws IOException{
		if(in!=null && out!=null){
			...
			while((len = bis.read(bytes))!=-1){
				...
				if(loadedLength%200==0 && handler!=null){
