...
public class WriteWeiboActivity extends Activity {
	...
	private String successText = "鍒嗕韩鎴愬姛銆�";
	private String failText = "鍒嗕韩澶辫触銆�";
	private String sendingText = "鍒嗕韩涓�鈥";
	...
	OnClickListener listener = new OnClickListener() {
		...
		public void onClick(View view) {
			...
			case R.id.share_image_delete:
				DialogUtils.dialogBuilder(mInstance, "鎻愮ず", "纭畾瑕佹竻闄ゅ浘鐗囧悧锛�",
						new DialogCallBack() {
							@Override
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == REQUEST_CODE_ADDIMAGE) {
			...
			if (!"photo".equals(MediaUtils.getContentType(attFormat))) {
				weiboImgPath = null;
				Toast.makeText(mContext, "璇烽�鎷╁浘鐗囨枃浠躲�", Toast.LENGTH_SHORT).show();
				return;
			}
