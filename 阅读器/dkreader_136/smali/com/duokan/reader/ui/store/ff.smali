.class public Lcom/duokan/reader/ui/store/ff;
...
.method public constructor <init>(Landroid/content/Context;Lcom/duokan/reader/ui/store/ky;)V
    ...
    .line 30
    iput-object p2, p0, Lcom/duokan/reader/ui/store/ff;->e:Lcom/duokan/reader/ui/store/ky;
    ...
    .line 34
    invoke-virtual {p0}, Lcom/duokan/reader/ui/store/ff;->getResources()Landroid/content/res/Resources;
    ...
    .line 36
    new-instance v3, Lcom/duokan/reader/ui/store/fg;

    invoke-direct {v3, p0}, Lcom/duokan/reader/ui/store/fg;-><init>(Lcom/duokan/reader/ui/store/ff;)V
    ...
    iput-object v1, p0, Lcom/duokan/reader/ui/store/ff;->a:Lcom/duokan/reader/ui/store/LimitGridView;

    .line 45
    iget-object v1, p0, Lcom/duokan/reader/ui/store/ff;->a:Lcom/duokan/reader/ui/store/LimitGridView;

    new-instance v4, Lcom/duokan/reader/ui/store/fh;

    invoke-direct {v4, p0}, Lcom/duokan/reader/ui/store/fh;-><init>(Lcom/duokan/reader/ui/store/ff;)V
    ...
    .line 61
    new-instance v3, Lcom/duokan/reader/ui/store/fi;

    invoke-direct {v3, p0}, Lcom/duokan/reader/ui/store/fi;-><init>(Lcom/duokan/reader/ui/store/ff;)V
    ...
    iput-object v1, p0, Lcom/duokan/reader/ui/store/ff;->b:Lcom/duokan/reader/ui/store/LimitGridView;

    .line 70
    iget-object v1, p0, Lcom/duokan/reader/ui/store/ff;->b:Lcom/duokan/reader/ui/store/LimitGridView;
    ...
    new-instance v4, Lcom/duokan/reader/ui/store/fj;

    invoke-direct {v4, p0}, Lcom/duokan/reader/ui/store/fj;-><init>(Lcom/duokan/reader/ui/store/ff;)V
    ...
    .line 83
    invoke-virtual {p0}, Lcom/duokan/reader/ui/store/ff;->g()Lcom/duokan/reader/ui/store/kj;

    move-result-object v1

    iput-object v1, p0, Lcom/duokan/reader/ui/store/ff;->c:Lcom/duokan/reader/ui/store/kj;
    ...
    iput-object v1, p0, Lcom/duokan/reader/ui/store/ff;->d:Lcom/duokan/reader/ui/store/kj;

    .line 85
    iget-object v1, p0, Lcom/duokan/reader/ui/store/ff;->a:Lcom/duokan/reader/ui/store/LimitGridView;

    iget-object v2, p0, Lcom/duokan/reader/ui/store/ff;->c:Lcom/duokan/reader/ui/store/kj;
    ...
    iget-object v2, p0, Lcom/duokan/reader/ui/store/ff;->d:Lcom/duokan/reader/ui/store/kj;

    invoke-virtual {v1, v2}, Lcom/duokan/reader/ui/store/LimitGridView;->setAdapter(Landroid/widget/BaseAdapter;)V

    .line 88
    invoke-virtual {p0, v0}, Lcom/duokan/reader/ui/store/ff;->setContentView(Landroid/view/View;)V

    .line 89
    invoke-virtual {p0}, Lcom/duokan/reader/ui/store/ff;->d()V

    .line 90
    return-void
.end method

.method static synthetic a(Lcom/duokan/reader/ui/store/ff;)Lcom/duokan/reader/ui/store/ky;
    .locals 1
    .parameter

    .prologue
    .line 19
    iget-object v0, p0, Lcom/duokan/reader/ui/store/ff;->e:Lcom/duokan/reader/ui/store/ky;

    return-object v0
.end method

.method static synthetic b(Lcom/duokan/reader/ui/store/ff;)Lcom/duokan/reader/ui/store/kj;
    .locals 1
    .parameter

    .prologue
    .line 19
    iget-object v0, p0, Lcom/duokan/reader/ui/store/ff;->c:Lcom/duokan/reader/ui/store/kj;

    return-object v0
.end method

.method static synthetic c(Lcom/duokan/reader/ui/store/ff;)Lcom/duokan/reader/ui/store/kj;
    .locals 1
    .parameter

    .prologue
    .line 19
    iget-object v0, p0, Lcom/duokan/reader/ui/store/ff;->d:Lcom/duokan/reader/ui/store/kj;
...
.method public setAdsView([Lcom/duokan/reader/common/webservices/duokan/DkStoreAdsBookInfo;)V
    ...
    .line 121
    new-instance v1, Lcom/duokan/reader/ui/store/fk;

    invoke-direct {v1, p0}, Lcom/duokan/reader/ui/store/fk;-><init>(Lcom/duokan/reader/ui/store/ff;)V

    .line 134
    const v0, 0x7f0602fa

    invoke-virtual {p0, v0}, Lcom/duokan/reader/ui/store/ff;->findViewById(I)Landroid/view/View;
...
.method public setRankingData(Ljava/util/LinkedList;)V
    ...
    invoke-virtual {p0, v0}, Lcom/duokan/reader/ui/store/ff;->b(Z)V
